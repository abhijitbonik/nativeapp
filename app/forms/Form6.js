...
export default class Form2 extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      rowVisible:false,
      transferDetails: [
        <View key = '0' style={{borderWidth:1, marginHorizontal:15, marginVertical:10}}>
        <Formik
        enableReinitialize
        initialValues={{
          office:'',
  ...
  _toggleModal = () =>
    this.setState({ rowVisible: !this.state.rowVisible });
  ...
  render() {
    return (
      <View style={{flex: 1}}>
      <Header header='6/5 Choice of Schools' onPress={this._header} onLogout={this._logout} toggleLang={this._toggleLang} />
      {RenderIf(true)(
      ...
      <KeyboardAwareView>
        ...
        <Modal 
          isVisible={this.state.rowVisible}
          backdropOpacity={0}
          style={{
            backgroundColor:'#fff'
          }}
